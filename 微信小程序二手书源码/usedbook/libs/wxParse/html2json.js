    ...
    return HTMLParser(e, {
        start: function(e, t, r) {
            ...
            0 !== t.length && (o.attr = t.reduce(function(e, t) {
                ...
                return "class" == r && (console.log(s), o.classStr = s), "style" == r && (console.log(s), 
            ...
            if ("font" === o.tag) {
                ...
                i) if (o.attr[l]) {
                    var c = "size" === l ? n[o.attr[l] - 1] : o.attr[l];
                    o.attr.style.push(i[l]), o.attr.style.push(c), o.styleStr += i[l] + ": " + c + ";";
                }
            }
