...
function wxParse() {
    ...
    if ("html" == t) o = _html2json2.default.html2json(a, e), console.log(JSON.stringify(o, " ", " ")); else if ("md" == t || "markdown" == t) {
    ...
    var s = {};
    s[e] = o, n.setData(s), n.bindData = s, n.wxParseImgLoad = wxParseImgLoad, n.wxParseImgTap = wxParseImgTap;
}
...
function wxParseImgTap(e) {
    ...
    void 0 !== a && 0 < a.length && wx.previewImage({
        current: t,
        urls: this.bindData[a].imageUrls
    });
}
...
function calMoreImageInfo(e, t, a, i) {
    ...
    if (n && 0 != n.images.length) {
        var o = n.images, d = wxAutoImageCal(e.detail.width, e.detail.height, a, i), s = o[t].index, l = "" + i, g = !0, m = !1, h = void 0;
        try {
