...
Page({
    ...
    onLoad: function() {
        ...
        a && t.setData({
            ...
            bindPhone: !0
        }),  t.checkPlugin(), t.getMyInfo(), app.util.footer(t)
    ...
    getMyInfo: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                t.data.errno ? a.showIconToast(t.data.errmsg) : 1 == t.data.data.credit_setting.open && a.setData({
                    credit_on: !0
                });
            }
        }), app.util.request({
            ...
            success: function(t) {
                t.data.errno ? a.showIconToast(t.data.errmsg) : (console.log(t.data.data), a.setData({
                    my: t.data.data,
